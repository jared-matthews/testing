#!/usr/bin/perl
#
# Do not play with this script to attack others. It is illegal and besides, the source address is not spoofed
# so you are bound to get caught and end up in jail. Denial of Service is a serious offense.
# 
# Tested only with isolated scenario. DO NOT TRY THIS ON ANYONE BUT YOURSELF. You have been warned !!
# 
# Dr. Baloch Asif Phd - Digital Rupees testing
